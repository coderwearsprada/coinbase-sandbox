# 2024 MIT License
# Framework for getting coinbase market data and make trade decisions in Coinbase
# Sandbox environment

# cbpro package works for Coinbase Pro and Sandbox
# cbpro package only works with Python 3.9.0 or earlier version as of today
